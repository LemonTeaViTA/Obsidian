 ...
 */ 
 ...
 private final Concurrent[[HashMap核心原理|HashMap]] < String , AtomicLong > accessCounter = new [[并发工具类|ConcurrentHashMap]] <>(); 
 ...
 if ( isHotKey ( key )) { 
 // 随机选择一个副本 
 int replica = [[线程基础与ThreadLocal|ThreadLocal]]Random . current (). nextInt ( HOT_KEY_REPLI[[锁|CAS]] ); 
