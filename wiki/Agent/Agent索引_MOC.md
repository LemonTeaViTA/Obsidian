...
👉 **[[Coding Agent 工具集_MOC]]**
   - **[[文件与代码操作工具]]** — Read / Write / Edit / LSP 等
   - **[[命令执行与环境工具]]** — Bash / TaskStop / EnterWorktree 等
   - **[[联网与外部数据工具]]** — WebSearch / WebFetch / 分级 fallback / SSRF 防御
   - **[[工具集架构设计]]** — 工具描述 token 管理 / 分组过滤 / allowedTools 白名单 / MCP 动态工具
